<x-layouts.app :title="__('Dashboard')">
        ...
        <div class="flex flex-col md:flex-row md:items-center gap-8">
            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-2 gap-4 mt-6">
                    <div class="bg-white/60 dark:bg-neutral-700/30 rounded-xl p-4 border border-gray-300/60 dark:border-neutral-700/40 backdrop-blur-sm transition-all duration-300 hover:shadow-md">
            ...
            <!-- Quick actions card -->
            <div class="w-full md:w-80 lg:w-96 bg-white/70 dark:bg-neutral-800/60 rounded-2xl p-6 border border-gray-300/60 dark:border-neutral-700/40 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300">
    ...
    <div class="max-w-6xl mx-auto my-8 backdrop-blur-sm bg-white/80 dark:bg-neutral-800/80 shadow-xl rounded-3xl p-6 lg:p-8 border border-gray-100/40 dark:border-neutral-700/50 transition-all duration-300 relative overflow-hidden">
        <!-- Decorative elements - subtle background patterns -->
        <div class="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-emerald-400/10 to-transparent rounded-full blur-3xl -z-10"></div>
        <div class="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-teal-400/10 to-transparent rounded-full blur-3xl -z-10"></div>
        ...
        <div class="flex flex-col">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse(auth()->user()->urlLists()->latest()->take(3)->get() as $list)
                    ...
                    <div class="overflow-hidden group bg-white/60 dark:bg-neutral-700/30 rounded-2xl p-4 border border-gray-300/60 dark:border-neutral-700/40 backdrop-blur-sm transition-all duration-300 hover:shadow-lg relative"><!-- Status indicator -->
                ...
                @empty
                    <div class="col-span-3 bg-white/70 dark:bg-neutral-800/60 rounded-2xl p-8 border border-gray-300/60 dark:border-neutral-700/40 backdrop-blur-sm text-center">
